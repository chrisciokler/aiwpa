...
export interface WrapperInputProps extends VariantProps<typeof inputWrapperVariants> { }

export interface TextInputProps
  extends InputProps, WrapperInputProps, VariantProps<typeof inputVariants> {
