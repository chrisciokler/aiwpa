...
export const AI_EDGE_FUNCTION_URL =
...
export const templates = [
  {
    title: "Site resume",
    description:
      "What is the site submitted about. Explain all the features that it has and pricing plans if any.",
  },
  {
    title: "Post to YouTube script",
    description:
      "Make a presentational script for a YouTube video about the site submitted.",
  },
  {
    title: "Twitter Thread Generation",
    description:
      "Generate an engaging Twitter thread using the submitted site data.",
  },
  {
